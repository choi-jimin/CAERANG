    ...
    fetch(movie_url)
        ...
        .then(function (json) {
            ...
            for (let i = 0; i < movieJson.length; i++) {
                ...
                new_pTag_movieCd.append(`${movieJson[i].movieCd}`);
                new_pTag_movieNm.append(`${movieJson[i].movieNm}`);
                new_pTag_movieOpenDt.append(`${movieJson[i].openDt.substr(0, 4)}`);
                ...
                new_pTag_movieCd.setAttribute('id', 'movie_code');
